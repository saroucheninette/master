...
var Core = function() {
    ...
    var runSideMenu = function() {
        ...
        var toggleSideMenu = function() {
            if ($('body').hasClass('boxed-layout mobile-viewport')) {
                $('body').toggleClass('sidebar-persist');
            }
            else if ($('body').hasClass('mobile-viewport')) {
                $('body').toggleClass('sidebar-persist');
            }
            else {
    ...
    var runDemoJS = function() {
        ...
        $(window).load(function() {
            ...
            var scripts = {
                ...
                //elfinder: 		 'public/assets/plugins/elfinder/elfinder.min.js',
...
function richtextbox(id,text_id)
{
    CKEDITOR.replace(id);
    if(text_id !=null)
    {
        $('form').submit(function() {
           $('#'+text_id).val(CKEDITOR.instances[id].document.getBody().getText());
        });
   }
}
