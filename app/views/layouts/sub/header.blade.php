...
<!-- Start: Header -->
<header class="navbar navbar-fixed-top" style="display:block;height: 71px;">
    
  <div class="pull-left"> <a class="navbar-brand" href="{{ URL::to('/')}}">
    <div class="navbar-logo"><img src="{{ URL::asset('assets/images/logo.png') }}" class="img-responsive" alt="logo"/></div>
    </a>
  </div>
  ...
  <div class="pull-right header-btns">
      ...
      <ul class="dropdown-menu checkbox-persist" role="menu">
        ...
        <li class="dropdown-header">{{ trans('messages.account') }} <span class="pull-right glyphicons glyphicons-user"></span></li>
        <li>
